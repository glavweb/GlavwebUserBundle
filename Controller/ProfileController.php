...
class ProfileController extends BaseProfileController
{
    ...
    public function showAction()
    {
        ...
        $view      = 'FOSUserBundle:Profile:show.html.' . $this->container->getParameter('fos_user.template.engine');
    ...
    public function editAction(Request $request)
    {
        ...
        $adminPool = $this->container->get('sonata.admin.pool');
        $view = 'FOSUserBundle:Profile:edit.html.'.$this->container->getParameter('fos_user.template.engine');
        return $this->container->get('templating')->renderResponse($view, array(
